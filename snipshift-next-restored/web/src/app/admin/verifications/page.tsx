...
import { GET_PENDING_VERIFICATIONS, APPROVE_USER, REJECT_USER } from '@/graphql/admin';
...
export default function AdminVerificationsPage() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography variant="h4" component="h1" gutterBottom className="animate-slide-up">
