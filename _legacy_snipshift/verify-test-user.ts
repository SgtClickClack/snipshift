 ...
 * 
 * Run with: npx tsx _legacy_snipshift/verify-test-user.ts <email>
 * 
...
║    npx tsx _legacy_snipshift/verify-test-user.ts <email> "postgresql://..."   ║
║                                                                              ║
║  What it does:                                                               ║
...
║                                                                              ║
║  Example:                                                                    ║
║    npx tsx _legacy_snipshift/verify-test-user.ts johnny@endeavour.com        ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
`);
  process.exit(0);
