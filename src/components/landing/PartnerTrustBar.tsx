            ...
            <Tooltip key={partner.id}>
              <TooltipTrigger asChild>
                <a
                  ...
                  className={cn(
                    "flex items-center gap-2 transition-opacity hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#BFFF00]/50 focus:ring-offset-2 focus:ring-offset-transparent rounded",
