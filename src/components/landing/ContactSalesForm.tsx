    ...
    return (
      ...
      >
        ...
        <div className="relative text-center py-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-primary/20 rounded-full mb-6 ring-4 ring-primary/30">
            <CheckCircle2 className="w-10 h-10 text-primary" />
          </div>
          <h3 className="text-3xl font-black text-white mb-4">Message Sent!</h3>
          <div className="text-primary font-bold text-lg p-4 bg-primary/10 rounded-xl border border-primary/20 inline-block">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full bg-black/50 border-2 ${
                    errors.companyName ? 'border-red-500' : 'border-zinc-800 focus:border-primary'
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-black/50 border-2 border-zinc-800 text-white rounded-xl p-4 pl-12 focus:border-primary outline-none transition-all placeholder:text-zinc-600"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full bg-black/50 border-2 ${
                    errors.email ? 'border-red-500' : 'border-zinc-800 focus:border-primary'
                  } text-white rounded-xl p-4 pl-12 outline-none transition-all placeholder:text-zinc-600`}
                  required
                />
              </div>
            ...
            <div>
              ...
              <div className="relative group">
                <Users className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-500 group-focus-within:text-primary transition-colors" />
                <input
                  type="number"
          ...
          <div>
            ...
            <div className="relative group">
              <MessageSquare className="absolute left-4 top-4 w-5 h-5 text-zinc-500 group-focus-within:text-primary transition-colors" />
              <textarea
                id="message"
                name="message"
                ...
                rows={4}
                className="w-full bg-black/50 border-2 border-zinc-800 text-white rounded-xl p-4 pl-12 focus:border-primary outline-none transition-all resize-none placeholder:text-zinc-600"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-primary text-primary-foreground font-black py-4 rounded-xl hover:shadow-[0_0_30px_hsl(var(--primary)/0.4)] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none flex items-center justify-center gap-2 text-lg"
          >
            {isSubmitting ? (
              <>
