                  ...
                  <div className="mt-8 flex-1">
                    {activeSlide.layout === 'standard' && (
                      <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/15 via-transparent to-transparent p-5">
                          <div className="flex items-center gap-3">
                    ...
                    {activeSlide.layout === 'engine' && (
                      <div className="grid gap-6 lg:grid-cols-2">
                        <div className="rounded-2xl border border-primary/30 bg-zinc-900/60 p-5">
                          <div className="flex items-center gap-3">
                        ...
                        <div className="rounded-2xl border border-blue-500/30 bg-zinc-900/60 p-5">
                          ...
                          <div className="mt-4 grid grid-cols-2 gap-3 text-xs text-zinc-400">
                            <div className="rounded-lg border border-zinc-800 bg-zinc-950/70 p-3">
                              <p className="text-primary font-semibold">Mutex TTL</p>
                    ...
                    {activeSlide.layout === 'financials' && (
                      <div className="grid gap-6 lg:grid-cols-2">
                        <div className="rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/15 via-transparent to-transparent p-6">
                          <p className="text-xs uppercase tracking-widest text-zinc-500">
                            Projected ARR
                          </p>
                          <p className="mt-2 text-4xl font-black text-primary">$178,800</p>
                          <p className="mt-3 text-sm text-zinc-400">
                            Brisbane 100 baseline with weighted pipeline.
                          </p>
                          <div className="mt-5 grid grid-cols-2 gap-3 text-xs text-zinc-400">
                            <div className="rounded-lg border border-zinc-800 bg-zinc-950/70 p-3">
                              <p className="text-primary font-semibold">Committed ARR</p>
                              ...
                              <div className="mt-3 rounded-xl border border-zinc-800 bg-zinc-950/80 p-4">
                                ...
                                <div className="mt-3 grid grid-cols-2 gap-3 text-xs text-zinc-300">
                                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
                                    <p className="text-primary font-semibold">Smart Fill</p>
                                    <p className="mt-2 text-zinc-500">Realtime staffing loop</p>
                                  </div>
                                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
                                    <p className="text-primary font-semibold">Compliance Vault</p>
                                    <p className="mt-2 text-zinc-500">DVS + RSA verified</p>
                                  </div>
                                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
                                    <p className="text-primary font-semibold">Xero Mutex</p>
                                    <p className="mt-2 text-zinc-500">Atomic payroll sync</p>
                                  </div>
                                  <div className="rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
                                    <p className="text-primary font-semibold">ARR Engine</p>
