 ...
 * Captures the beforeinstallprompt event and provides a function to trigger the install prompt
...
export function useInstallPrompt() {
   ...
   * @returns Promise that resolves when the user responds to the prompt
   */
