...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: {
        ...
        pathNot: '^virtual:'  // Vite/vitest virtual modules (e.g. virtual:pwa-register/react)
      }
    },
    {
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          'vite-env[.]d[.]ts$'  // Vite ambient type declarations - dev-only, stripped at build
        ]
      },
      to: {
        dependencyTypes: [
  ...
  options: {
    ...
    doNotFollow: {
      ...
      path: [
        'node_modules',
        '^virtual:pwa-register/react$'  // Vite PWA plugin virtual module
      ]
    },
...
// generated: dependency-cruiser@17.3.7 on 2026-02-06T02:27:44.867Z
