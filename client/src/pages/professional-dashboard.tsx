...
export default function ProfessionalDashboard() {
  ...
  // Get the appropriate testid based on user's role
  const getDashboardTestId = () => {
    if (!user?.currentRole) return 'professional-dashboard';
    return user.currentRole === 'barber' ? 'barber-dashboard' : 'professional-dashboard';
  };
